...
class Whitebit:
    ...
    def __init__(self):
        ...
        # self.basUrl = "https://whitebit.com"
        self.market = "BTC_USDT"
        self.orderbookUrl = f"https://whitebit.com/api/v2/public/depth/{self.market}"
...
# whitebit = Whitebit()
# orderbook_data = whitebit.get_orderbook()
# topask = whitebit.get_orderbook()
# topbit = whitebit.get_orderbook()
# print(topask, topbit)
